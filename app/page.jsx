...
export default function Home() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      const scale = Math.min(300, window.innerWidth * 0.3) / Math.max(width, height);
...
.text-above { font-size: ${labelHeight * 0.12}px; font-weight: bold; text-align: center; width: 100%; }
...
.text-below { font-size: ${labelHeight * 0.1}px; font-weight: bold; text-align: center; width: 100%; }
@media print { body { margin: 0; padding: 0; } .label { border: none; margin: 0; } }
</style>
</head>
<body>
<div class="label">
...
<\/script>
  ...
  if (!isMounted) {
    return <div style={{ minHeight: '100vh', background: '#fafaf9', padding: '20px' }}></div>;
  }

  return (
    <div style={{ minHeight: '100vh', background: '#fafaf9', fontFamily: 'sans-serif', padding: '20px' }}>
      <div style={{ textAlign: 'center', marginBottom: '40px' }}>
        <h1 style={{ fontSize: '32px', fontWeight: 'bold', margin: '0 0 8px 0' }}>Barcode Label Generator</h1>
        <p style={{ color: '#666', fontSize: '16px', margin: '0' }}>Design and print labels for your thermal printer</p>
      </div>
